# Madhayana Market v6 - QRIS Asli + DANA QRIS MPM
...
## Perbaikan v6
- `firebase-admin` dihapus dari dependency agar Vercel tidak gagal saat `npm install`.
- `package-lock.json` dihapus agar Vercel membuat lock baru yang bersih.
- Endpoint notify tetap bisa update Firestore memakai Firebase Web SDK. Pastikan Firestore Rules sementara masih mengizinkan write saat testing.
